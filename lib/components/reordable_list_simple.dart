...
// This was not written by Neil,
// it is an open source widget that was pulled from this url:
...
class ReorderableItemSimple extends StatelessWidget {
  ...
  BoxDecoration _decoration(BuildContext context, ReorderableItemState state) {
    if (state == ReorderableItemState.dragProxy ||
      ...
      return BoxDecoration(color: Color(0x88000000));
    } else {
      ...
      return BoxDecoration(
          border: Border(
              ...
              bottom: placeholder
                  ? BorderSide.none
                  : Divider.createBorderSide(context)),
          color: placeholder ? null : backgroundColor);
    }
  }
